 ...
 * @author tasni
 */
public class FireArmsLicenseController implements Initializable {
    ...
    @FXML
    private RadioButton radioButtonYesforPreviousLicences;
    @FXML
    private ToggleGroup tgconfirmation1;
    @FXML
    private RadioButton radioButtonNoforPreviousLicences;
