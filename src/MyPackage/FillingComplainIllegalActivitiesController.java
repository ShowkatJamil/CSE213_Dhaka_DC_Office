 ...
 * @author tasni
 */
public class FillingComplainIllegalActivitiesController implements Initializable {
    ...
    @FXML
    private void submitComplaintButtonOnClick(ActionEvent event) throws IOException {
