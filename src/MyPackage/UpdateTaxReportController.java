...
public class UpdateTaxReportController implements Initializable {

    @FXML
    private AnchorPane updateTaxRecordAnchorPane;
    @FXML
    private TableView<?> updateTaxReportsTableView;
    @FXML
    ...
    @FXML
    private void changeCollectedTaxCellEvent(TableColumn.CellEditEvent<TaxRate, Integer> event) {
    }

    @FXML
    private void updateRemarksCellEvent(TableColumn.CellEditEvent<TaxRate, Integer> event) {
    }
