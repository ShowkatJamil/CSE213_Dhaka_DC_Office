 ...
 * @author User
 */
public class CheckTaxFraudController implements Initializable {
    ...
    @FXML
    private TableView<?> landTaxReportsTableView1;
    @FXML
    private TableColumn<?, ?> dueKhatianColumn;
    @FXML
    private TableColumn<?, ?> dueTaxColumn;
    ...
    @FXML
    private void calculateDueButtonOnClick(ActionEvent event) {
    }
