 ...
 * @author tasni
 */
public class FoodGrainLicenseController implements Initializable {
    ...
    @FXML
    private void submitOnButtonOnClick(ActionEvent event) throws IOException {
    ...
    @FXML
    private void logOutOnButtonOnClick(ActionEvent event) throws IOException {
